...
const SeatSelectionPage: React.FC = () => {
  ...
  const handleSeatSelection = (seat: string) => {
    ...
    router.push(
      `/checkout?movieId=${movieId}&title=${encodeURIComponent(title as string)}&showtime=${showtime}&seat=${seat}`,
    );
  };
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor =
                styles.seatButtonHover.backgroundColor;
              e.currentTarget.style.transform =
                styles.seatButtonHover.transform;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor =
                styles.seatButton.background;
