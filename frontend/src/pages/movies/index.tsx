  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-100 p-4 sm:p-6 md:p-8">
      <header className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-orange-800 text-center mb-6">Movie Theater</h1>
      ...
      <main className="space-y-12">
        <MovieSection title="Currently Running" movies={currentlyRunningMovies} />
...
const MovieSection: React.FC<{ title: string; movies: Movie[] }> = ({ title, movies }) => (
  <section>
    <h2 className="text-2xl sm:text-3xl font-semibold text-orange-700 mb-6">{title}</h2>
    {movies.length > 0 ? (
      ...
      <p className="text-lg text-orange-600 bg-orange-100 p-4 rounded-lg shadow">No {title.toLowerCase()} movies available</p>
    )}
  </section>
);
