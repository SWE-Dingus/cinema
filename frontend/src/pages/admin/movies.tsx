...
const ManageMovies: React.FC = () => {
  ...
  <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div>
        <label className="block text-sm font-medium">Age Rating (e.g., G, PG13, NC17)</label>
        <input
          type="text"
      ...
      <div>
        ...
        <input
          ...
          className="border p-2 rounded w-full"
        />
        <button onClick={addCastMember} className="bg-blue-500 text-white mt-2 px-4 py-2 rounded">
          Add Cast Member
        </button>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="border p-2 rounded w-full"
        />
        <button onClick={addCategory} className="bg-green-500 text-white mt-2 px-4 py-2 rounded">
          Add Category
        </button>
      </div>
